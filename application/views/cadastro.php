	...
	<form class="form-inline">
		<fieldset>
			...
			<div class="span12">
				...
				<input class="span4" type='text' name='Name' id='a' placeholder="Nome Completo" />
				
				<label class="control-label">Email</label>
				
				<input class="span3" type='email' name='email' id='b' placeholder="Email" />
				
				<label class="control-label">Senha</label>
				
				<input class="span2" type='password' name='senha' id='L' placeholder="Senha"/><br/><br/>
				
				<label class="control-label">Data de Nascimento</label>
				
				<input class="span3" type="date" name='nascimento' id='j' placeholder="12/12/1990"/>
				
				<label class="control-label">Telefone</label>
				
				<input class="span2" type='text' name='phone' id='c' placeholder="(38)9121-1232"/>
				
				<label class="control-label">Telefone 2</label>

				<input class="span2" type='text' name='phone2' id='d' placeholder="(38)9121-1232"/><br/><br/>

				<label class="control-label">Função</label>

				<input class="span3" type="text" name='funcao' id='l' placeholder="Diretor de marketing"/><br/><br/>
				...
				<div class="input-append">
					<input class="span7" id="estado" name="estado" placeholder="Escolha uma opção" type="text">
					<div class="btn-group">
				...
				<input class="span2" type="text" name='cep' id='k' placeholder="39.440-000"/>
				
				<label class="control-label">Bairro</label>

				<input class="span2" type='text' name= 'bairro' id='h' placeholder="Bairro"/>
				
				<label class="control-label">Cidade</label>

				<input class="span2" type= 'text'  name= 'cidade' id= 'i' placeholder="Cidade"/><br/><br/>
				<label class="control-label">Rua</label>

				<input class="span3" type='text' name='rua' id='e' placeholder="Rua"/>

				<label class="control-label">Número</label>

				<input class="span2" type='text' name= 'numero' id='numero' placeholder="Número"/>

				<label class="control-label">Complemento</label>

				<input class="span3" type='text' name= 'complemento' id='g' placeholder="Complemento"/>
